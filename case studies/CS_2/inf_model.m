function [dxdt,dxbind_dt,dxnucl_dt] = inf_model(t,x,x_bind,x_nucl,...
    ...
    dI2dt=dI2dt+growthI2;
    dCodt=dCodt+growthCo;
    dSdt=D*(Sin-S)-(Ys_T*T+Ys_I1*sum(I1)+Ys_I2*sum(I2)+Ys_C*sum(Co))*S/(1e-2/scaling+S);
    ...
    dxdt(4:end)=[dI1dt dI2dt dCodt dNVdt dSdt];
