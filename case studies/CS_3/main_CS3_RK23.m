function [t,x,x_bind,x_nucl,sum_h] = main_CS3_RK23(t_vect, x0, ...
    ...
    [k1,k1_bind,k1_nucl]=inf_model_CS3(t0,x0,x0_bind,x0_nucl,...
    ...
    while t<t_final
        ...
        [k2, k2_bind, k2_nucl]=inf_model_CS3(t+h/2,x+k1*h/2,x_bind+k1_bind*h/2,x_nucl+k1_nucl*h/2,...
            r_bleed, Cin, Sin, D, k_bind_I1, k_bind_I2, k_bind_Co1, k_bind_Co2, mu_T, ...
            mu_I1, mu_I2, mu_Co, k_deathT, k_death_I1, k_death_I2, k_death_Co, ...
            f_death_Co1, f_death_Co2, tau_death_I1, tau_death_I2, ...
            tau_death_Co, k_int_I1, k_int_I2, k_int_Co1, ...
            ...
            endCo, startB1,startB2, n_bins_inf,age_bins,...
            ind_scB1Co,ind_scB2Co,n_bins,age_co,ind,startB1Co,startB2Co,scaling,k_lys);
        [k3, k3_bind, k3_nucl]=inf_model_CS3(t+3*h/4,x+3*k2*h/4,x_bind+3*k2_bind*h/4,x_nucl+3*k2_nucl*h/4,...
            r_bleed, Cin, Sin, D, k_bind_I1, k_bind_I2, k_bind_Co1, k_bind_Co2, mu_T, ...
            mu_I1, mu_I2, mu_Co, k_deathT, k_death_I1, k_death_I2, k_death_Co, ...
            f_death_Co1, f_death_Co2, tau_death_I1, tau_death_I2, ...
            tau_death_Co, k_int_I1, k_int_I2, k_int_Co1, ...
        ...
        [k4, k4_bind, k4_nucl]=inf_model_CS3(t_new,x_new,x_bind_new,x_nucl_new,...
            r_bleed, Cin, Sin, D, k_bind_I1, k_bind_I2, k_bind_Co1, k_bind_Co2, mu_T, ...
            mu_I1, mu_I2, mu_Co, k_deathT, k_death_I1, k_death_I2, k_death_Co, ...
            f_death_Co1, f_death_Co2, tau_death_I1, tau_death_I2, ...
            tau_death_Co, k_int_I1, k_int_I2, k_int_Co1, ...
        ...
        if err_est <= rtol
            ...
            if sum_h >= Dtau || t>=t_final
                ...
                [k1,k1_bind,k1_nucl]=inf_model_CS3(t,x,x_bind,x_nucl,...
                    r_bleed, Cin, Sin, D, k_bind_I1, k_bind_I2, k_bind_Co1, k_bind_Co2, mu_T, ...
                    mu_I1, mu_I2, mu_Co, k_deathT, k_death_I1, k_death_I2, k_death_Co, ...
                    f_death_Co1, f_death_Co2, tau_death_I1, tau_death_I2, ...
                    tau_death_Co, k_int_I1, k_int_I2, k_int_Co1, ...
