...
function p = def_parameters(age_viab,age_end_inf,Dtau,scaling,DIP)   
    ...
    for i1=1:n_bins
        for i2=1:n_bins
            if (i1-i2)^2 < n_bins_inf^2
                ...
                if DIP % infection age for STV/DIP coinfected cells
                    current_age=((i1))*Dtau;
                    if i2==n_bins
                        current_age=((i2)-1)*Dtau;
                    end
                else % infection age for STV1/STV2 coinfected cells
